...
function openNew(){openAutomation(null)}$("#newAutomationTop").onclick=openNew;$("#newAutomationButton").onclick=openNew;$$("[data-close-automation]").forEach(x=>x.onclick=()=>$("#automationModal").hidden=true);$("#automationSearch").oninput=apply;$("#automationCategory").onchange=apply;$("#automationState").onchange=apply;$("#refreshAutomations").onclick=load;$("#automationSearchTrigger").onclick=()=>$("#automationSearch").focus();await load();
})();
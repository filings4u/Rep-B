...
$('forgotForm').addEventListener('submit',async event=>{
  ...
  try{
    ...
    showMessage('If that email is associated with a filings4u client account, a password-reset link has been sent. Please check your inbox and spam folder.','ok');
    $('forgotForm').reset();
  }catch(error){

/**
 * ==========================================================================
 * 🗂️ FILINGS4U GOVERNMENT-LEVEL DATA REGISTRY MASTER ENGINE (First Half)
 * ==========================================================================
 */
...
window.WIZARD_REGISTRY = {
  ...
  "llc-formation": {
    ...
    extraFields: [
      ...
      /* --- Deep Additions for State Automation --- */
  ...
  "payroll-tax": {
    ...
    extraFields: [
      ...
      /* --- Deep Additions for State Automation --- */
      { id: "state_unemployment_id", label: "State Unemployment Insurance (SUI) ID (If already issued)", type: "text", placeholder: "Leave blank if requesting new assignment" }
    ]
  },
  ...
  "franchise-tax": {
    ...
    extraFields: [
      ...
      /* --- Deep Additions for State Automation --- */
      { id: "franchise_state_jurisdiction", label: "Target Franchise Tax State Department", type: "text", placeholder: "e.g., Delaware Division of Corporations" }
    ]
  },
  /* ==========================================================================
     💸 CATEGORY 3: TAX REPORTING SCHEDULES & REGISTRATIONS (CONTINUED)
     ========================================================================== */
  "payroll-tax": {
    title: "Payroll Withholding Tax Setup (940/941)",
    ...
    extraFields: [
      { id: "expected_employees", label: "Estimated Total W2 Employees on Payroll", type: "text", placeholder: "e.g., 5" },
      { id: "first_payroll_date", label: "Anticipated Date of First Wage Payment", type: "text", placeholder: "MM/DD/YYYY" },
      /* --- Expanded Form Fields for Copy-Paste Processing --- */
  ...
  /* ==========================================================================
     🛡️ CATEGORY 5: COMMERCIAL RISK INSURANCE & PERFORMANCE AUDITS
     ========================================================================== */
  "trucker-insurance": {
